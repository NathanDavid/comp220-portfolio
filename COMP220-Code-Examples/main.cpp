...
int main(int argc, char ** argsv)
{
	...
	while (running)
	{
		...
		glm::mat4 rotate = matPitch * matYaw; //got rid of roll as it seemed irrelevent.
		glm::mat4 translate = glm::mat4(1.0f);
		glm::vec2 mouse_delta = glm::vec2(rotation.x, rotation.y) = cameraPosition;
		matYaw += mouseX_Sensitivity * mouse_delta.x;
		matPitch += mouseY_Sensitivity * mouse_delta.y;
